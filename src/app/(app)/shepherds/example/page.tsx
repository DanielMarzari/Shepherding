...
export default function ShepherdsPage() {
  ...
  return (
    <AppShell active="Shepherds" breadcrumb={`Shepherds › ${f.name} (example)`}>
      <div className="px-5 md:px-7 py-7">
        <div className="mb-4 px-3 py-2 rounded border border-border-soft bg-bg-elev text-xs text-muted">
          Demo with mock data. The real shepherds list lives at{" "}
          <a href="/shepherds" className="text-accent hover:underline">/shepherds</a>{" "}
          — this page is kept as the layout reference for the individual-shepherd
