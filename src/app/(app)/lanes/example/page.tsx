...
/** Design preview of the Activity / Lanes page, running on fake
 *  mock data only. Kept around as the visual reference for what the
 *  page should look like once every lane (Worship + Giving +
 *  Outreach) has a real data source wired. The live page at /lanes
 *  reads from person_activity + the real snapshot tables; this one
 *  is purely a mockup. */
export default function LanesExamplePage() {
  return (
    <AppShell active="Activity / Lanes" breadcrumb="Lanes › Design preview">
      <div className="px-5 md:px-7 py-7">
        <div className="rounded-lg border border-dashed border-accent/50 bg-accent/5 px-4 py-3 mb-6 flex items-baseline justify-between gap-3 flex-wrap">
          <div className="text-xs">
            <span className="text-accent font-medium">Design preview</span>
            <span className="text-muted ml-2">
              Mock data only — what the page should look like once every
              lane has a real source. Live page is at{" "}
              <Link href="/lanes" className="text-accent hover:underline">
                /lanes
              </Link>
              .
            </span>
