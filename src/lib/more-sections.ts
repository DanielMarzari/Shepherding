...
const BASE: Array<{ title: string; blurb?: string; links: GalleryLink[] }> = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/sermon-impact", title: "Sermon impact", description: "What each sermon called people toward — giving, groups, serving, outreach — lined up against measurable congregation activity in the 5 weeks after. Bridges Sermon Lab transcripts to your PCO data." },
